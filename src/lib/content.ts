...
export const images = {
  ...
  aboutOffice: "/images/venue/about-office.webp",
  aboutPitches: "/images/venue/about-pitches.webp",
  contactPhoto: "/images/venue/contact-photo.webp",
...
export const fields: Field[] = [
  {
    ...
    name: "Field 1",
    shortName: "Field 1",
    description: "A full-size football pitch at the ArmourX Sports venue in Iskandar Puteri.",
    surface: "Football pitch",
    facilityFacts: [
      { label: "Size", value: "Full-size" },
      { label: "Lighting", value: "Floodlit" },
      { label: "Sessions", value: "Morning & evening" },
    ],
    image: images.fieldOne,
    imageAlt: "A match in full flow on Field 1 at ArmourX Sports, Iskandar Puteri",
    features: ["Full-size pitch", "Floodlit", "Morning session", "Evening session"],
  },
  {
    id: "FIELD_02",
    slug: "field-two",
    ...
    imageAlt: "Players passing the ball on Field 2 at ArmourX Sports, Iskandar Puteri",
    features: ["Full-size pitch", "Floodlit", "Morning session", "Evening session"],
  },
];
