...
export const homeCopy: Record<SiteLocale, HomeCopy> = {
  en: {
    ...
    groundTitle: "The grounds at Iskandar Puteri.",
    ...
    bookingStatusLive: "Live availability. Lock in your pitch in under a minute.",
    bookingStatusFallback: "Booking is open. Pick a day, pick a session, and you're on.",
    ...
    faqFallback: [
      ...
      { question: "When is a booking confirmed?", answer: "As soon as everything is settled, you'll see it on the booking result page and in your confirmation email." },
    ...
    degraded: "Service temporarily unavailable. We're really sorry about this — please try again in a moment, or email armourxsports@gmail.com for any queries.",
  },
  bm: {
    ...
    groundTitle: "Padang di Iskandar Puteri.",
    ...
    bookingStatusLive: "Ketersediaan langsung. Kunci padang anda dalam masa seminit.",
    bookingStatusFallback: "Tempahan dibuka. Pilih hari, pilih sesi, dan anda sudah bersedia.",
    ...
    faqFallback: [
      ...
      { question: "Bilakah tempahan disahkan?", answer: "Sebaik sahaja segala-galanya selesai, anda akan lihat pada halaman keputusan tempahan dan dalam e-mel pengesahan anda." },
    ...
    degraded: "Perkhidmatan tidak tersedia buat sementara waktu. Kami benar-benar minta maaf — sila cuba lagi sebentar lagi, atau e-mel armourxsports@gmail.com untuk sebarang pertanyaan.",
  },
};
