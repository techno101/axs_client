...
`axs_client` is an independent Vercel public consumer of the admin-generated pinned v1.10.0 contract (`2e87ee580902c0253b79b3901e8c60a2b9bb312672ad4bab7c2f7a8035b569cd`). It owns no server authority, database connection, payment secret, webhook, admin UI or POS behavior.
